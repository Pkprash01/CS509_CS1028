...
#### Objective
Convert graph adjacency list inputs into Compressed Sparse Row (CSR) array representations[cite: 1].
...
| Single | `csr_input_10000.txt` | 10,000 | 20,000 | Adjacency List | Converted to CSR | 32.607 ms | Pass |
